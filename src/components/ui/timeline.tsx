...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10 sm:pt-20 px-4"
      ref={containerRef}
    >
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              {/* content */}
              <div>
                <div className="mb-8 space-y-2 text-neutral-800 dark:text-neutral-200 text-xs md:text-lg font-normal">
                  {item.description && (
                  <p>
